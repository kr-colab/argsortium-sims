...
def main():
    ...
    contig_start = int(snakemake.wildcards.start)
    contig_end = int(snakemake.wildcards.end)
    ...
    contig = species.get_contig(contig_name, genetic_map=genetic_map, left = contig_start, right = contig_end)
